...
pkgdatadir = $(datadir)/apertium-udm-kpv
pkgincludedir = $(includedir)/apertium-udm-kpv
pkglibdir = $(libdir)/apertium-udm-kpv
pkglibexecdir = $(libexecdir)/apertium-udm-kpv
...
am__installdirs = "$(DESTDIR)$(apertium_udm_kpvdir)"
DATA = $(apertium_udm_kpv_DATA) $(noinst_DATA)
...
ACLOCAL = ${SHELL} /home/socur/Documents/kpv-udm/hfst/apertium-udm-kpv/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
APERTIUM_CFLAGS = -I/usr/include/apertium-3.5 -I/usr/lib/x86_64-linux-gnu/apertium-3.5/include -I/usr/include/lttoolbox-3.4 -I/usr/lib/x86_64-linux-gnu/lttoolbox-3.4/include -I/usr/include/libxml2
APERTIUM_LIBS = -lapertium3 -llttoolbox3 -lxml2 -lpcre
AP_LIB1 = ../giella-udm/tools/mt/apertium
AP_LIB2 = ../giella-kpv/tools/mt/apertium
AP_SRC1 = ../giella-udm/tools/mt/apertium
AP_SRC2 = ../giella-kpv/tools/mt/apertium
AP_SUBDIRS =  ../giella-udm/tools/mt/apertium ../giella-kpv/tools/mt/apertium
AUTOCONF = ${SHELL} /home/socur/Documents/kpv-udm/hfst/apertium-udm-kpv/missing autoconf
AUTOHEADER = ${SHELL} /home/socur/Documents/kpv-udm/hfst/apertium-udm-kpv/missing autoheader
AUTOMAKE = ${SHELL} /home/socur/Documents/kpv-udm/hfst/apertium-udm-kpv/missing automake-1.15
AWK = gawk
CGCOMP = /usr/bin/cg-comp
CGPROC = /usr/bin/cg-proc
CGRELABEL = /usr/bin/cg-relabel
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"Apertium\ Northern\ Saami-Lule\ Saami\" -DPACKAGE_TARNAME=\"apertium-udm-kpv\" -DPACKAGE_VERSION=\"0.5.1\" -DPACKAGE_STRING=\"Apertium\ Northern\ Saami-Lule\ Saami\ 0.5.1\" -DPACKAGE_BUGREPORT=\"trondtr@users.sourceforge.net\" -DPACKAGE_URL=\"http://wiki.apertium.org/wiki/Apertium-udm-kpv\" -DPACKAGE=\"apertium-udm-kpv\" -DVERSION=\"0.5.1\"
ECHO_C = 
ECHO_N = -n
ECHO_T = 
GIELLA_KPV_CFLAGS = 
...
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/socur/Documents/kpv-udm/hfst/apertium-udm-kpv/missing makeinfo
MKDIR_P = /bin/mkdir -p
PACKAGE = apertium-udm-kpv
PACKAGE_BUGREPORT = trondtr@users.sourceforge.net
PACKAGE_NAME = Apertium Northern Saami-Lule Saami
PACKAGE_STRING = Apertium Northern Saami-Lule Saami 0.5.1
PACKAGE_TARNAME = apertium-udm-kpv
PACKAGE_URL = http://wiki.apertium.org/wiki/Apertium-udm-kpv
...
VERSION = 0.5.1
ZCAT = /bin/zcat
abs_builddir = /home/socur/Documents/kpv-udm/hfst/apertium-udm-kpv
abs_srcdir = /home/socur/Documents/kpv-udm/hfst/apertium-udm-kpv
abs_top_builddir = /home/socur/Documents/kpv-udm/hfst/apertium-udm-kpv
abs_top_srcdir = /home/socur/Documents/kpv-udm/hfst/apertium-udm-kpv
am__leading_dot = .
...
install_sh = ${SHELL} /home/socur/Documents/kpv-udm/hfst/apertium-udm-kpv/install-sh
...
###############################################################################
###############################################################################
apertium_udm_kpvdir = $(prefix)/share/apertium/$(BASENAME)/

# Files which should be installed to $(prefix)/share/apertium/$(BASENAME)/:
apertium_udm_kpv_DATA = \
        $(TARGETS_COMMON)		\
	$(BASENAME).$(PREFIX1).t1x	\
	$(BASENAME).$(PREFIX1).t2x	\
	$(BASENAME).$(PREFIX1).t3x	\
...
$(am__aclocal_m4_deps):
install-apertium_udm_kpvDATA: $(apertium_udm_kpv_DATA)
	@$(NORMAL_INSTALL)
	@list='$(apertium_udm_kpv_DATA)'; test -n "$(apertium_udm_kpvdir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(apertium_udm_kpvdir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(apertium_udm_kpvdir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(apertium_udm_kpvdir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(apertium_udm_kpvdir)" || exit $$?; \
	done

uninstall-apertium_udm_kpvDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(apertium_udm_kpv_DATA)'; test -n "$(apertium_udm_kpvdir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(apertium_udm_kpvdir)'; $(am__uninstall_files_from_dir)
tags TAGS:
...
installdirs:
	for dir in "$(DESTDIR)$(apertium_udm_kpvdir)"; do \
...
install-data-am: install-apertium_udm_kpvDATA install-data-local
...
uninstall-am: uninstall-apertium_udm_kpvDATA
...
.PHONY: all all-am am--refresh check check-am clean clean-generic \
	...
	install install-am install-apertium_udm_kpvDATA install-data \
...
# This include deudmes goals for install-modes, .deps/.d and .mode files:
...
test-install: all
	...
	echo "Leage buorre" | apertium -d tmp-$@/$(prefix)/share/apertium udm-kpv | tee tmp-$@/mt
	@echo "Liege buorre" > tmp-$@/ref
	@diff tmp-$@/ref tmp-$@/mt
	@rm -rf tmp-$@

test: all test-install
	echo "Leage buorre" | apertium -d . udm-kpv | tee .test-mt
